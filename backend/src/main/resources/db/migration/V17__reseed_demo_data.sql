-- V17: Re-seed demo data. Users already exist; all other tables were wiped.
-- Truncate clears data and restarts sequences so hardcoded IDs match.
...
INSERT INTO order_items (order_id, product_id, total_quantity, unit_price, total_price) VALUES
  (1, 1,  350, 294.00,  102900.00),
  (1, 2,  350, 336.00,  117600.00),
  (1, 10, 280, 315.00,   88200.00),
  (1, 11, 280, 294.00,   82320.00);

INSERT INTO order_items (order_id, product_id, total_quantity, unit_price, total_price) VALUES
  (2, 1,  200, 294.00,  58800.00),
  (2, 3,  200, 900.12, 180024.00),
  (2, 10, 160, 315.00,  50400.00),
  (2, 13, 160, 441.00,  70560.00);
...
INSERT INTO order_items (order_id, product_id, total_quantity, unit_price, total_price) VALUES
  (4, 7,  220, 360.45,  79299.00),
  (4, 17, 180, 360.45,  64881.00),
  (4, 21, 260, 168.00,  43680.00);
...
INSERT INTO class_student_counts (order_item_id, class_name, boys_count, girls_count, total_count) VALUES
  (1,'1st',25,0,25),(1,'2nd',28,0,28),(1,'3rd',30,0,30),(1,'4th',32,0,32),
  (1,'5th',30,0,30),(1,'6th',35,0,35),(1,'7th',33,0,33),(1,'8th',32,0,32),
  (1,'9th',30,0,30),(1,'10th',28,0,28),(1,'11th',14,0,14),(1,'12th',13,0,13);

INSERT INTO class_student_counts (order_item_id, class_name, boys_count, girls_count, total_count) VALUES
  (2,'1st',25,0,25),(2,'2nd',28,0,28),(2,'3rd',30,0,30),(2,'4th',32,0,32),
  (2,'5th',30,0,30),(2,'6th',35,0,35),(2,'7th',33,0,33),(2,'8th',32,0,32),
  (2,'9th',30,0,30),(2,'10th',28,0,28),(2,'11th',14,0,14),(2,'12th',13,0,13);

INSERT INTO class_student_counts (order_item_id, class_name, boys_count, girls_count, total_count) VALUES
  (3,'1st',0,20,20),(3,'2nd',0,22,22),(3,'3rd',0,25,25),(3,'4th',0,26,26),
  (3,'5th',0,24,24),(3,'6th',0,28,28),(3,'7th',0,27,27),(3,'8th',0,26,26),
  (3,'9th',0,24,24),(3,'10th',0,22,22),(3,'11th',0,11,11),(3,'12th',0,9,9);

INSERT INTO class_student_counts (order_item_id, class_name, boys_count, girls_count, total_count) VALUES
  (4,'1st',0,20,20),(4,'2nd',0,22,22),(4,'3rd',0,25,25),(4,'4th',0,26,26),
  (4,'5th',0,24,24),(4,'6th',0,28,28),(4,'7th',0,27,27),(4,'8th',0,26,26),
  (4,'9th',0,24,24),(4,'10th',0,22,22),(4,'11th',0,11,11),(4,'12th',0,9,9);
